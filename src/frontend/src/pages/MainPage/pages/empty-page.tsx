...
const EMPTY_PAGE_TITLE = "Welcome to QuarkGen";
const EMPTY_PAGE_DESCRIPTION = "Your favorite way to create and manage AI Agents";
          ...
          <div className="z-50 flex h-full w-full flex-col items-center justify-center gap-5">
            <div className="z-50 flex flex-col items-center gap-2">
              <div className="z-50 dark:hidden">
                <img
                  src={logoLightPng}
                  alt="QuarkGen Logo Light"
                  data-testid="empty_page_logo_light"
                  className="relative top-3 mb-6 w-[20px] sm:w-[25px] md:w-[30px] lg:w-[35px] xl:w-[40px] 2xl:w-[45px]"
                />
              </div>
              <div className="z-50 hidden dark:block">
                <img
                  src={logoDarkPng}
                  alt="QuarkGen Logo Dark"
